...
tbl_clean <- mutate(tbl_clean, gender4 = recode(gender, "[2]" = "1", "[1]" = "2", "[5]" = "3", .default = "other", .missing = NULL),
                   edu7 = recode(edu, '1' = 'no highschool','2' = 'no highschool', '3' = 'some highschool',
